...
def BFS(problem):
    return graph_search(problem,0)

def DFS(problem):
    return graph_search(problem,-1)



p = graphProblem('Arad','Bucharest',graph)
goalNode=BFS(p)
#print("BFS =>",goalNode.solution(),"Path Cost: ",goalNode.path_cost)

p1 = graphProblem('Arad','Bucharest',graph)
goalNode1=DFS(p)
#print("DFS =>",goalNode1.solution(),"Path Cost: ",goalNode1.path_cost)
